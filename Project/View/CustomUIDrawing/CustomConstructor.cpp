...
CustomConstructor::CustomConstructor(QWidget *parent)
    : QWidget{parent}
{
...
void CustomConstructor::AddNewPipeline()
{
    CustomContainer *container = new CustomContainer;
    this->_panels.append(container);
    layout()->addWidget(container);
    connect(container, &CustomContainer::removeEmited, this, &CustomConstructor::RemoveContainer);
    update();
}

void CustomConstructor::RemoveContainer(CustomContainer *container)
{
    container->hide();
...
void CustomConstructor::contextMenuEvent(QContextMenuEvent *event)
{
...
void CustomConstructor::paintEvent(QPaintEvent*)
{
    int sphereRadius = 15;
    ...
    {
        painter.setPen(QPen(QColor(ColorController::Instance().GetLeftPanelColor()), 1));
        QFont font;
